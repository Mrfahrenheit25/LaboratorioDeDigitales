...
VL_ATTR_COLD void Vrvfpgasim_rvfpgasim___ctor_var_reset(Vrvfpgasim_rvfpgasim* vlSelf) {
    ...
    vlSelf->__PVT__i_sw = VL_RAND_RESET_I(1);
    ...
    vlSelf->__Vtriunconn7 = VL_RAND_RESET_I(1);
    vlSelf->__Vtriunconn9 = VL_RAND_RESET_I(1);
    vlSelf->__Vtriunconn11 = VL_RAND_RESET_I(1);
