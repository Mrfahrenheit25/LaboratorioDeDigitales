...
Vrvfpgasim_axi_demux_id_counters__pi5::Vrvfpgasim_axi_demux_id_counters__pi5(Vrvfpgasim__Syms* symsp, const char* v__name)
...
void Vrvfpgasim_axi_demux_id_counters__pi5::__Vconfigure(bool first) {
