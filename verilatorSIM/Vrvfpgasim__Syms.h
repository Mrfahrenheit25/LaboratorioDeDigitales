...
class Vrvfpgasim__Syms final : public VerilatedSyms {
  public:
    ...
    Vrvfpgasim_dpram64__S10000     TOP__rvfpgasim__ram__ram;
    Vrvfpgasim_swervolf_core       TOP__rvfpgasim__swervolf;
    ...
    Vrvfpgasim_wb_mem_wrapper__M1000 TOP__rvfpgasim__swervolf__bootrom;
    Vrvfpgasim_dpram64__S1000      TOP__rvfpgasim__swervolf__bootrom__ram;
