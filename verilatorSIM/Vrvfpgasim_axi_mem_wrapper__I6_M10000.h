...
class Vrvfpgasim_dpram64__S10000;


class Vrvfpgasim_axi_mem_wrapper__I6_M10000 final : public VerilatedModule {
  public:
    // CELLS
    Vrvfpgasim_dpram64__S10000* ram;
    ...
    CData/*0:0*/ __VdfgTmp_h0008b478__0;
    ...
    // CONSTRUCTORS
    Vrvfpgasim_axi_mem_wrapper__I6_M10000(Vrvfpgasim__Syms* symsp, const char* v__name);
