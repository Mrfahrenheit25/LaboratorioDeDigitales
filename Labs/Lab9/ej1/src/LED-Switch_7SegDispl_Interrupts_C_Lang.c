...
/* Clear PTC interrupt */
M_PSP_WRITE_REGISTER_32(RPTC_CTRL, 0x21); /* RGPIO_INTS */
...
/* Configure GPIO interrupts */
M_PSP_WRITE_REGISTER_32(RPTC_CNTR, 0x0); /* RPTC_LRC */
M_PSP_WRITE_REGISTER_32(RPTC_LRC, 0xA000); /* RPTC_LRC */
M_PSP_WRITE_REGISTER_32(RPTC_HRC, 0xA000); /* RPTC_LRC */
M_PSP_WRITE_REGISTER_32(RGPIO_CTRL, 0x21); /* RGPIO_INTE */
...
ExternalIntLine_Initialization(3, 7, PTC_ISR); /* Initialize line IRQ3 with a priority of 6. Set PTC_ISR as the Interrupt Service Routine */
